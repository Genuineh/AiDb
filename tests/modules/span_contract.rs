...
const HOT_PATH_SPANS: &[(&str, &str)] = &[
    ...
    ("src/engine/db/inner/write.rs", "name = \"db_delete\""),
    ("src/engine/db/inner/read.rs", "name = \"db_scan\""),
    ("src/engine/db/inner/write.rs", "name = \"db_write_batch\""),
    (
        "src/engine/db/inner/write.rs",
        "name = \"db_write_batch_no_wal\"",
    ),
    ("src/engine/db/inner/write.rs", "name = \"db_delete_range\""),
