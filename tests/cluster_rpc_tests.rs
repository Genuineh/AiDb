...
async fn test_primary_node_basic_operations() {
    ...
    async fn test_primary_node_rpc_get() {
        ...
        let mut client = StorageClient::connect("http://127.0.0.1:50052")
            .await
            .unwrap();
    ...
    async fn test_primary_node_rpc_put() {
        use aidb::cluster::rpc::proto::{storage_client::StorageClient, PutRequest, GetRequest};
        ...
        // Create client
        let mut client = StorageClient::connect("http://127.0.0.1:50053")
            .await
            .unwrap();
    ...
    async fn test_primary_node_health_check() {
        ...
        let mut client = StorageClient::connect("http://127.0.0.1:50054")
            .await
            .unwrap();
