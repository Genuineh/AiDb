...
```json
{
  "path": "../../archive/13-architecture.md",
  "limit": 100
}
```
...
```json
{
  "path": "../../../aidb-oldmain/docs/DESIGN_DECISIONS.md"
}
```
...
{
  "limit": 80,
  "path": "../../../aidb-oldmain/docs/THIN_REPLICATION_PLAN.md"
}
```
...
{
  "limit": 50,
  "path": "../../../aidb-oldmain/src/cluster/thin_replication.rs"
}
```
...
```json
{
  "path": "../../../aidb-oldmain/src/memtable",
...
```bash
wc -l ../../../aidb-oldmain/src/lib.rs ../../src/engine/db/inner.rs 2>/dev/null; find ../../../aidb-oldmain/src -name '*.rs' | wc -l; find ../../src -name '*.rs' | wc -l
```
...
{
  "limit": 30,
  "path": "../../../aidb-oldmain/src/cache/lru.rs"
}
```
