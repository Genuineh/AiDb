...
use aidb::cluster::{RaftConfig, RaftNode, RaftStateMachine, RaftStorage, encode_put, encode_delete, StateMachine};
use aidb::{Options, DB};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("------------------------------");
    println!("  Node 1: ID={}, Election Tick={}, Heartbeat Tick={}", 
        node1.id(), config1.election_tick, config1.heartbeat_tick);
    println!("  Node 2: ID={}, Election Tick={}, Heartbeat Tick={}", 
        node2.id(), config2.election_tick, config2.heartbeat_tick);
    println!("  Node 3: ID={}, Election Tick={}, Heartbeat Tick={}", 
        node3.id(), config3.election_tick, config3.heartbeat_tick);
    println!();
